    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(-30, 0), Math.toRadians(0)))
                        ...
                        .strafeToLinearHeading(new Vector2d(-50, 30), Math.toRadians(0), velPuternic,accelPuternic)
                        .strafeToLinearHeading(new Vector2d(-50, 50), Math.toRadians(0), velPuternic,accelPuternic)
                        .strafeToLinearHeading(new Vector2d(-8, 50), Math.toRadians(0), velPuternic,accelPuternic)

                        .strafeToLinearHeading(new Vector2d(-50, 37), Math.toRadians(0), velPuternic,accelPuternic)
                        .strafeToLinearHeading(new Vector2d(-50, 57), Math.toRadians(0), velPuternic,accelPuternic)
                        .strafeToLinearHeading(new Vector2d(-8, 55), Math.toRadians(0), velPuternic,accelPuternic)
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(new Vector2d(3, 35), Math.toRadians(0)))
                        ...
                        .strafeToConstantHeading(new Vector2d(-31, -8), baseVelConstraint,baseAccelConstraint)
                        .afterTime(0, () -> {
                            arms.updateGripperScorePosition(GLOBALS.grippers_positions.Deschis);
                        })
                        .build());
