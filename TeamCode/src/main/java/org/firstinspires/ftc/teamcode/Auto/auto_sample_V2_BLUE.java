...
@Autonomous(name = "auto_sample_V2_BLUE")
public class auto_sample_V2_BLUE extends LinearOpMode {
    @Override
...
//
        ...
        if(senzori.hasSample()){
            ...
            while (true) {
                ...
                if(senzori.hasSample() && senzori.isBlueOrYellow( senzori.senzorIntakeCuloare.red(), senzori.senzorIntakeCuloare.green(),senzori.senzorIntakeCuloare.blue() )) {
                    arms.updateGripperIntakePosition(GLOBALS.grippers_positions.Inchis);
                    sleep( 300 );
                    arms.updateBratIntakePosition(GLOBALS.brat_intake_positions.Intake);
                    sleep( 300 );
